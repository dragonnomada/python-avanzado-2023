#
# Podemos crear un auto-bloqueo mediante la estructura de control `with`
#
# La estructura `with` hará que las variables `Lock` se bloqueen
# y desbloqueen automáticamente cuándo los procesos finalizan
#
